...
file: plot.py
date: 8/21/23
purpose: using matplotlib, run simulation centering an object in the image using gpt interpretor
"""
...
# establish object_name and step_size
object_name = "cat"
step_size = 2
...
while(True):
    ...
    # Plot 3D graph with object bounding box and drone
    ...
    # Plot 2D graph with object's center relative to drone's field of view
    fig, ax = plt.subplots(figsize=[7,6], layout='constrained')

    # color centered relative area
