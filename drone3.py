...
3. If the object is centered in the image, the agent will move closer to the object unless either the height or width are greater than 0.7. In this case, the agent will hover.
4. Every object in an instruction should be treated as a different object from previous instructions.
5. Ensure that each element of the ["step_instructions"] explains the corresponding element of the ["task_sequence"].
6. The length of the ["step_instructions"] list must be the same as the length of the ["task_sequence"] list, which is one.
7. Perform a consistent movement as a nano-drone, following the seven rules.'''})
...
"question":""}'''})
conversation.append({'role': 'user', 'content': 'Follow the person in blue at [0.20, 0.17, 0.50, 0.65]'})
conversation.append({'role': 'assistant', 'content': '''{"task_explanation": "Since the person's x_center (0.45) is greater than 0.40 and less than 0.60, the person is centered horizontally in the image. Since the y_center (0.495) is greater than 0.40 and less than 0.60, the person is also centered vertically in the image. Both the person's width and height are not greater than 0.7 so the person is at a far enough distance to move forward.",
"task_cohesion": {
    "task_sequence": [
        "move_forward()"
    ],
...
"question":""}'''})
conversation.append({'role': 'user', 'content': 'Follow the bus at [0.19, 0.09, 0.80, 0.65]'})
conversation.append({'role': 'assistant', 'content': '''{"task_explanation": "Since the person's x_center (0.59) is greater than 0.40 and less than 0.60, the person is centered horizontally in the image. Since the ball's y_center (0.415) is greater than 0.40 and less than 0.60, the person is also centered vertically in the image. The bus's width is greater than 0.7 so the bus is at a close enough distance to hover.",
"task_cohesion": {
    "task_sequence": [
        "hover()"
    ],
